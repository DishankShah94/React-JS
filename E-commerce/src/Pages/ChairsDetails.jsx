...
const ChairsDetails = () => {
    ...
    const data = async (productId, selectedValue) => {
        const res = await fetch(`http://localhost:5000/ChairCategory/${productId}`);
    ...
    const fetchProductDetails = async () => {
        try {
            const response = await fetch(`http://localhost:5000/ChairCategory/${id}`);
